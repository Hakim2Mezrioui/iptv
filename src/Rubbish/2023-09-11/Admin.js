        ...
        <React.Fragment>
            ...
            <form className={classes["form-auth"]}>
                ...
                <div className={classes["form-group"]}>
                    <input onBlur={onCheckValues} ref={username} />
                    <label className={`${usernameVal == "" ? "" : classes.notEmpty}`}>Username</label>
                </div>
                <div className={classes["form-group"]}>
                    <input ref={password} />
                    <label className={`${passwordVal == "" ? "" : classes.notEmpty}`}>Password</label>
                </div>
